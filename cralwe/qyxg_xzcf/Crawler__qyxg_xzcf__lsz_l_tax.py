...
class Crawler__qyxg_xzcf__lsz_l_tax(SCLocalBaseCrawl):
    """四川省地方税务局-税务行政处罚公告数据 - 遂宁"""
    name = 'Crawler__qyxg_xzcf__lsz_l_tax'
    
    start_urls = ['http://lsz.sc-l-tax.gov.cn/cdssxc/xzgs/xzcfgs/index.html']
    
    next_page_tpl = 'http://lsz.sc-l-tax.gov.cn/cdssxc/xzgs/xzcfgs/index_{}.html'
