...
-------------------------------------------------
    ...
    File Name:        specific_spiders/qyxg_xzcf/Crawler__credit_fengjie_base.py

    Description:      信用奉节-行政许可&行政处罚 基类

    Author:           dengliangwen@bbdservice.com

    Date:             2018-08-15-11:24:43

    Version:          v1.0

    Lastmodified:     2018-08-15 by Jack Deng
-------------------------------------------------
"""
...
class Crawler__credit_fengjie_base(Spider):
    """
    class Crawler__credit_fengjie_base for
    信用奉节-行政许可&行政处罚 基类
    """

    name = "Crawler__credit_fengjie_base"
    ...
    filter_keywords_for_page = {
        'http://fengjie.hlxy.com/documents/api/queryCreditPublicity?pageNum=.*': {
            'pass_key_word': [''],
        },
    }
