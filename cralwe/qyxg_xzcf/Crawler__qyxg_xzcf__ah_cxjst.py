...
"""
-------------------------------------------------
    File Name:      Crawler__qyxg_xzcf__ah_cxjst.py
    Description:    行政处罚 - 安徽省住房和城乡建设厅
    Author:         hyy
    Date:           2017-11-21
    version:        v.1.0
-------------------------------------------------
...
class Crawler__qyxg_xzcf__ah_cxjst(SpiderAll):
    """
    行政处罚 - 安徽省住房和城乡建设厅
    """
    name = 'Crawler__qyxg_xzcf__ah_cxjst'
    ...
    def custom_init(self, *args, **kwargs):
        ...
        self.list_url = "http://www.ahjst.gov.cn/ahzjt_Front/Infoservice/Information.asmx/GetInfoListExtendCF"
        self.detail_url = "http://www.ahjst.gov.cn/ahzjt_Front/Infoservice/Information.asmx/GetDetailCF"
        self.header = {
    ...
    def handle_result(self, response, result_dict, info_id):
        ...
        item['bbd_html'] = ''
        item['bbd_url'] = response.url + '?CategoryNum=014013&InfoID={}'.format(info_id)
