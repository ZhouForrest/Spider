...
-------------------------------------------------
    ...
    File Name:        parsers/manual_parser/qyxg_xzcf/Parser__qyxg_xzcf__credit_wuxi.py

    Description:      信用巫溪-行政处罚 解析

    Author:           dengliangwen@bbdservice.com

    Date:             2018-08-21-15:24:50
...
class Parser__qyxg_xzcf__credit_wuxi(ManualBaseParser):
    """
    class Parser__qyxg_xzcf__credit_wuxi for
    信用巫溪-行政处罚 解析
    """

    name = "Parser__qyxg_xzcf__credit_wuxi"
    parser_info = "信用巫溪-行政处罚 解析"
    base_dict = {
        "version": 1,
    }
