...
-------------------------------------------------
    ...
    File Name:        manual_parser/qyxg_xzxk/Parser__qyxg_xzxk__credit_fengjie.py

    Description:      信用奉节-行政许可 解析

    Author:           dengliangwen@bbdservice.com

    Date:             2018-08-20-11:22:18
...
class Parser__qyxg_xzxk__credit_fengjie(ManualBaseParser):
    """
    class Parser__qyxg_xzxk__credit_fengjie for
    信用奉节-行政许可 解析
    """

    name = "Parser__qyxg_xzxk__credit_fengjie"
    parser_info = "信用奉节-行政许可 解析"
    base_dict = {
        "version": 1,
    }
